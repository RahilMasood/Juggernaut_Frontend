...
import { ShieldCheck, Layers, Lock, FileCheck2, Building2 } from "lucide-react";

type PPELandingProps = {
...
const categories: Array<{
...
}> = [
  {
    ...
    description: "Customize the audit program with entity-specific questions and responses.",
    icon: Layers,
  ...
  },
  {
    id: "ppe-romms",
    title: "RoMMs",
    description: "Identify and assess risks of material misstatement relevant to PPE.",
    icon: ShieldCheck,
  ...
  },
  {
    ...
    description: "Evaluate design and implementation of key PPE-related controls.",
    icon: Lock,
  ...
  },
  {
    ...
    description: "Perform detailed procedures over PPE balances and transactions.",
    icon: FileCheck2,
    accent: "from-fuchsia-500/20 to-purple-500/20",
  },
];

export default function PPELanding({ onSelect }: PPELandingProps) {
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-xl font-semibold text-white">Property, Plant & Equipment</h2>
