...
import { ShieldCheck, Layers, Lock, FileCheck2, Building } from "lucide-react";
...
type PropertyPlantEquipmentProps = {
...
const categories: Array<{
  ...
  },
  {
    ...
    title: "RoMMs",
    description:
      "Identify and assess risks of material misstatement relevant to property, plant & equipment.",
    icon: ShieldCheck,
  ...
  },
  {
    ...
    description:
      "Evaluate design and implementation of key PPE-related controls.",
    icon: Lock,
  ...
  },
  {
    ...
    description:
      "Perform detailed procedures over PPE balances and transactions.",
    icon: FileCheck2,
    accent: "from-fuchsia-500/20 to-purple-500/20",
  },
];

export default function PropertyPlantEquipment({ onSelect }: PropertyPlantEquipmentProps) {
