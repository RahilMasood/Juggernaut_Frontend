...
export default function PPEIPETesting({ onBack }: PPEIPETestingProps) {
  ...
  const executeIPE = async () => {
    ...
    try {
      ...
      const result = await window.payroll.run("execute_ppe_ipe_mapping", {
        inputFiles: [],
        options: {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-white">IPE Testing - Property, Plant & Equipment</h2>
